...
builder.Services.AddCors(options => {
  options.AddPolicy("ServiFinanceFrontendClients", policy => {
    policy.SetIsOriginAllowed(origin =>
            ...
            origin.StartsWith("http://0.0.0.0", StringComparison.OrdinalIgnoreCase) ||
            origin.StartsWith("https://0.0.0.0", StringComparison.OrdinalIgnoreCase) ||
...
static void MapReactPublicApp(WebApplication app) {
  var distRoot = Path.Combine(app.Environment.ContentRootPath, "src", "frontend", "ServiFinance.Frontend", "dist");
  ...
  app.MapGet("/{tenantDomainSlug}/sms", (string tenantDomainSlug) => Results.File(Path.Combine(distRoot, "index.html"), "text/html"));
  app.MapGet("/{tenantDomainSlug}/sms/", (string tenantDomainSlug) => Results.File(Path.Combine(distRoot, "index.html"), "text/html"));
  app.MapGet("/{tenantDomainSlug}/sms/dashboard", (string tenantDomainSlug) => Results.File(Path.Combine(distRoot, "index.html"), "text/html"));
  app.MapGet("/{tenantDomainSlug}/sms/users", (string tenantDomainSlug) => Results.File(Path.Combine(distRoot, "index.html"), "text/html"));
  app.MapGet("/{tenantDomainSlug}/mls", (string tenantDomainSlug) => Results.File(Path.Combine(distRoot, "index.html"), "text/html"));
  app.MapGet("/{tenantDomainSlug}/mls/", (string tenantDomainSlug) => Results.File(Path.Combine(distRoot, "index.html"), "text/html"));
  app.MapGet("/{tenantDomainSlug}/mls/dashboard", (string tenantDomainSlug) => Results.File(Path.Combine(distRoot, "index.html"), "text/html"));
