...
namespace ServiFinance.Infrastructure.Migrations
{
    ...
    [Migration("20260511151730_AddPersistentAuthProtection")]
    partial class AddPersistentAuthProtection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServiFinance.Domain.AmortizationSchedule", b =>
                {
                    ...
                    b.Property<DateTime?>("LateFeeAppliedAtUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ServiFinance.Domain.TenantCostingPolicy", b =>
                {
                    ...
                    b.Property<bool>("LoanLateFeeEnabled")
                        .HasColumnType("bit");

                    b.Property<decimal>("LoanLateFeeFlatAmount")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)");

                    b.Property<int>("LoanLateFeeGracePeriodDays")
                        .HasColumnType("int");

                    b.Property<decimal>("LoanLateFeeRatePercent")
                        .HasPrecision(6, 2)
                        .HasColumnType("decimal(6,2)");
