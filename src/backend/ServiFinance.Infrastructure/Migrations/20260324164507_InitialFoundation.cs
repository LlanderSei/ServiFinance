        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedServiceDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterestableAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusLogs_ServiceRequests_ServiceRequestId",
                        column: x => x.ServiceRequestId,
                        principalTable: "ServiceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MicroLoans_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MicroLoans_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MicroLoans_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MicroLoanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AmortizationSchedules_MicroLoans_MicroLoanId",
                        column: x => x.MicroLoanId,
                        principalTable: "MicroLoans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MicroLoanId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AmortizationScheduleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_AmortizationSchedules_AmortizationScheduleId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_MicroLoans_MicroLoanId",
                        column: x => x.MicroLoanId,
                        principalTable: "MicroLoans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmortizationSchedules_MicroLoanId_InstallmentNumber",
                table: "AmortizationSchedules",
                columns: new[] { "MicroLoanId", "InstallmentNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AmortizationSchedules_TenantId",
                table: "AmortizationSchedules",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MicroLoans_CreatedByUserId",
                table: "MicroLoans",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MicroLoans_CustomerId",
                table: "MicroLoans",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusLogs_ServiceRequestId",
                table: "StatusLogs",
                column: "ServiceRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_StatusLogs_TenantId",
                table: "StatusLogs",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AmortizationScheduleId",
                table: "Transactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_MicroLoanId",
                table: "Transactions",
                column: "MicroLoanId");
